package com.mybatis.ld.example.util;
...
//    }
     ...
     */
    public static Map<String,Object> classFieldMap2SqlFieldMap(Map<String,Object> param, Class<?> clz){
        ...
        Map<String,Object> sqlQuery = new HashMap<String,Object>(map);
        return sqlQuery;
    }
